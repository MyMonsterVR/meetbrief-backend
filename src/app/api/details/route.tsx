...
export async function GET(req: NextRequest, res: NextApiResponse) {
    ...
    const transcripts = await db
        ...
        .from(trancripts)
        .where(and(
            eq(trancripts.userId, Number.parseInt(decoded.userid)),
            eq(trancripts.id, Number.parseInt(id as string))
        ))
...
export async function DELETE(params: NextRequest, res: NextApiResponse) {
